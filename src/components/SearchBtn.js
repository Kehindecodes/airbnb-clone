	...
	return (
		<Box>
			...
			<ButtonGroup variant='text' className={classes.card}>
				<Button className={classes.btnCnt} onClick={click}>
					<Typography className={classes.country}>Helsinki, Finland</Typography>
				</Button>
				<Button className={classes.btnCnt} onClick={click}>
					{' '}
					<Typography className={classes.guest}>Add guests</Typography>
				</Button>
